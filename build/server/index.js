    ...
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 md:px-12 pt-8 sm:pt-12 min-w-0", children: /* @__PURE__ */ jsxs("div", { children: [
          ...
          ) : /* @__PURE__ */ jsx("p", { className: "mt-3 sm:mt-4 max-w-[68rem] text-base sm:text-lg md:text-xl text-white/80 leading-relaxed", children: serviceDescription })
        ] }) }),
